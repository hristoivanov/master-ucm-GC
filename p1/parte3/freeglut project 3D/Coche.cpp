...
void Coche::avanza(GLfloat f){
	...
	elemento[1]->rotacion[2] = elemento[1]->rotacion[2] - (f / 3.14) * 180.0f;
	elemento[2]->rotacion[2] = elemento[2]->rotacion[2] - (f / 3.14) * 180.0f;
	elemento[3]->rotacion[2] = elemento[3]->rotacion[2] + (f / 3.14) * 180.0f;
	elemento[4]->rotacion[2] = elemento[4]->rotacion[2] + (f / 3.14) * 180.0f;
