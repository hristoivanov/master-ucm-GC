...
Coche::Coche() {
	...
	elemento[5] = new Cilindro(1.7, 4, 4);
	elemento[5]->setEscalado(.2, .2, 1.0);
	elemento[5]->setRotacion(0.0, 90, 0.0);
	elemento[5]->setPosicion(1.5, 0.0, -0.5);
	elemento[5]->setColor(0, 1.0, .0);

	elemento[6] = new Cilindro(1.7, 4, 4);
	elemento[6]->setEscalado(.2, .2, 1.0);
	elemento[6]->setRotacion(0.0, 90, 0.0);
	elemento[6]->setPosicion(1.5, 0.0, 0.5);
	elemento[6]->setColor(.0, 1.0, .0);
...
void Coche::avanza(GLfloat f){
	...
	elemento[1]->rotacion[2] = elemento[1]->rotacion[2] - 2 * 3.14 * f;
	elemento[2]->rotacion[2] = elemento[2]->rotacion[2] - 2 * 3.14 * f;
	elemento[3]->rotacion[2] = elemento[3]->rotacion[2] + 2 * 3.14 * f;
	elemento[4]->rotacion[2] = elemento[4]->rotacion[2] + 2 * 3.14 * f;
